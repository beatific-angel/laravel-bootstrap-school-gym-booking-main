            ...
            <div class="container">
                ...
                <ul class="navbar-nav navbar-right ml-auto">    
                    @guest
                        ...
                        @endif
                    @else
                        @if(Request::path() != 'view/request')
                            <li class="nav-item">
                                <a class="nav-link" href="#" id="create-contact" data-toggle="modal" data-target="#modal-create-contact"><i class="fa fa-book"></i> Create Booking</a>
                            </li>
                        @endif  
                        <li class="nav-item pl-4 pl-1">
                            <span class="navbar-text text-white">Administrator <span class="k">{{ Auth::user()->name }}</span>!</span>
                        </li>         
                        <li class="nav-item">                            
